...
class PantallaMenu implements Screen {
    ...
    private void crearMenu() {
        ...
        TextureRegionDrawable btnJugar = new TextureRegionDrawable(new TextureRegion(new Texture("btnIN.png")));
        TextureRegionDrawable btnJugarOprimido = new TextureRegionDrawable(new TextureRegion(new Texture("btnIN2.png")));

        ImageButton btnSpace = new ImageButton(btnJugar,btnJugarOprimido);
